...
@section('content')
    ...
    <script type="text/javascript">
        function generatePDF() {
            ...
            // Add custom font if you have one
            // doc.addFileToVFS('Roboto-Regular.ttf', '<base64 string>');
            ...
            doc.autoTable({
                ...
                theme: 'grid',
                styles: {
                    font: 'helvetica', // Temporarily using default font
                    fontSize: 8,
                    textColor: [0, 0, 0],
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.data.forEach((element) => {
                        ...
                        $('#report').append(
                            `<tr><td>${element.platform}</td><td>${element.tracking_id}</td><td>${element.full_name}</td><td>${element.phone}</td><td>${element.payment}</td><td>${element.amount}</td><td>${element.time}</td></tr>`
                        );
