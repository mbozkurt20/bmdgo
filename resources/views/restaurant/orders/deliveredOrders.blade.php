    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
            <div class="customer-search">
                <div class="input-group search-area">
                    <input type="text" class="form-control" id="custom-filter-delivered" placeholder="Sipariş ara...">
        ...
        <div class="card card-body">
            <div class="table-responsive">
                <table id="ordersTable" class="table table-striped table-hover text-black" style="min-width: 1000px;">
                    <thead>
                    <tr>
                        <th>Platform</th>
                        <th>Sipariş No</th>
