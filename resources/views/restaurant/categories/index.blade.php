        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
            <div class="customer-search mb-sm-0 mb-3">
                <div class="input-group search-area">
                    <input type="text" class="form-control"  id="custom-filter"  placeholder="Kategori ara..">
            ...
            <div class="col-xl-12 card-body">
                <div class="table-responsive">
                    <table id="example3" class="order-table shadow-hover card-table text-black" style="min-width: 845px">
                        <thead>
                        <tr>
                            <th style="width: 90%">Kategori Adı</th>
                        ...
                        @foreach($categories as $categorie)
                            <tr id="data_{{$categorie->id}}">
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{route('restaurant.categories.edit', ['id' => $categorie->id])}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                        <a onclick="DeleteFunction({{$categorie->id}})" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                    </div>
            ...
            Swal.fire({
                ...
                if (isConfirm.value) {
                    $.ajax({
                        ...
                        url: '/restaurant/categories/delete/' + event,
