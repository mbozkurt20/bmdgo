            ...
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">Restaurantlar</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('admin.restaurants') }}">Restaurantlar</a></li>
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="#">Yemeksepeti</a></li>
                        <li><a href="#">Getiryemek</a></li>
                      <li><a href="#">Trendyolyemek</a></li>
                    </ul>
                </li> -->
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('admin.couriers') }}">Kuryeler</a></li>
                            <li><a href="{{ route('admin.couriers.maps') }}">Kurye Takip</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('admin.deliveredOrders') }}">Teslim Edilen Siparişler</a></li>
                            <li><a href="{{ route('admin.deletedOrders') }}">İptal Edilen Siparişler</a></li>
                        </ul>
                    </li>

                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-040-graph"></i>
                            <span class="nav-text">Hakedişler</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('admin.progress_payment.restaurant') }}">Restorant Hakediş</a></li>
                            <li><a href="{{ route('admin.progress_payment.courier') }}">Kurye Hakediş</a></li>
                        </ul>
                    </li>
