                    ...
                    <table id="example3" class="display" style="min-width: 845px">
                        ...
                        @foreach($couriers as $courier)
                            <tr id="data_{{$courier->id}}">
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{route('admin.couriers.report', ['id' => $courier->id])}}" class="btn btn-secondary shadow btn-xs sharp me-1"><i class="fas fa-file-pdf"></i></a>
                                        <a href="{{route('admin.couriers.edit', ['id' => $courier->id])}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
