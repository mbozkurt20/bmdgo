<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .receipt-wrap{padding:8px} /* etraf boşluk biraz arttı */

        .receipt{
            width:320px; /* 80mm termal kağıt için */
            background:#fff; color:var(--ink);
            overflow:hidden; border:1px solid #eee;
        }
        .paper{padding:8px 12px 8px} /* üst ve alt padding azaltıldı */
        ...
        .order-no{font-size:22px; font-weight:800}
